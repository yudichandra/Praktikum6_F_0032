...
<table class="table table-bordered">
    <tr>
        ...
        <th width="280px" class="text-center">Student Phone</th>
        <th width="280px" class="text-center">Birthplace</th>
        <th width="280px" class="text-center">Birthdate</th>
...
<tr>
    ...
    <td class="text-center">
        ...
        <button type="submit" class="btn btn-danger btn-sm" oclick="return confirm('Apakah anda yakin ingin menghapus datta ini?')">Delete</button>
</form>
</td>
</tr>
@endforeach
